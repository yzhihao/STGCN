...
# os.system("python build_graph_mod2.py mr")

# if len(sys.argv) != 2:
# 	sys.exit("Use: python train.py <dataset>")

datasets = ['20ng', 'R8', 'R52', 'ohsumed', 'mr', 'weibo', "biomeical", "stackoverflow"]
# dataset = sys.argv[1]
dataset = 'mr'
...
save_str = "{:.5f}, {:.5f}, {}\n".format(test_cost, test_acc, seed_value)
with open("result/{}/r.txt".format(dataset), "a+") as f:
    f.write(save_str)
